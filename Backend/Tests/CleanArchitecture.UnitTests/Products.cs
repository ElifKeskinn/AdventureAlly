...
using Moq;
using static CleanArchitecture.Core.Features.Products.Commands.DeleteProductById.DeleteProductByIdCommand;
...
namespace CleanArchitecture.UnitTests
{
    public class Products
    {
        ...
        var command = this.fixture.Create<DeleteProductByIdCommand>();
