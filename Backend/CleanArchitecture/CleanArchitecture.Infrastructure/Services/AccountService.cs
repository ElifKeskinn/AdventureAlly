        ...
        public async Task<Response<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        From = "elif.keskin233@gmail.com",
                        To = user.Email,
                        Body = $"Please confirm your account by visiting this URL: {verificationUri}",
                        Subject = "Confirm Registration"
                    };

                    await _emailService.SendAsync(new Core.DTOs.Email.EmailRequest() { From = "elif.keskin233@gmail.com", To = user.Email, Body = $"Please confirm your account by visiting this URL {verificationUri}", Subject = "Confirm Registration" });
